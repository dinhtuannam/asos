...
const DataTableComponent = React.forwardRef<DataTableRef, DataTableProps<any, any>>(function DataTable<TData, TValue>(
    ...
    const debouncedTextSearch = useDebounce(defaultParam.TextSearch, 500, () => changePageIndex(1));
    ...
    const { data: paginate, loading } =
        !!api && !dataTable
            ? useFetch<PaginatedData<TData>>(api, { ...defaultParam, TextSearch: debouncedTextSearch }, [
                  defaultParam,
                  debouncedTextSearch,
                  fetch,
                  ...dependency,
        ...
        try {
            if (deleteApi && deleteId) {
                const payload: DeletePayload = {
                    ids: deleteId,
                    applicationUserId: '2a90750c-4082-4093-8feb-2586faf39264',
                };
